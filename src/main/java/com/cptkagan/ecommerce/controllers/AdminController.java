...
public class AdminController {
    ...
    @Operation(summary = "View sellers that waiting a moderator approve",
                responses = {
                    @ApiResponse(
                        responseCode = "200",
                        description = "Success",
                        content = @Content(
                            ...
                            schema = @Schema(type = "array", implementation = SellerResponseAdmin.class)
                        )
                    ),
                    @ApiResponse(
                        responseCode = "400",
    ...
    @Operation(summary = "Approve seller",
                responses = {
                    @ApiResponse(
                        responseCode = "200",
                        description = "Success",
                        content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(type = "string", example = "Seller approved. Now login is allowed!")
                        )
                    ),
                    @ApiResponse(
                        responseCode = "400",
    ...
    @Operation(summary = "Reject seller",
                responses = {
                    @ApiResponse(
                        responseCode = "200",
                        description = "Success",
                        content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(type = "string", example = "Seller rejected.")
                        )
                    ),
                    @ApiResponse(
                        responseCode = "400",
    ...
    @Operation(summary = "Approve rejected seller",
                responses = {
                    @ApiResponse(
                        responseCode = "200",
                        description = "Success",
